...
export default function ChatbotHero() {
  return (
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <motion.div
        className="absolute bottom-4 right-2 md:bottom-0 md:right-16 pointer-events-none select-none z-0 opacity-40 md:opacity-60"
      ...
      >
        <motion.div
          animate={{ y: [0, -11, 0], rotate: [0, 2, -2, 0] }}
          transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut', times: [0, 0.4, 0.7, 1] }}
          style={{
